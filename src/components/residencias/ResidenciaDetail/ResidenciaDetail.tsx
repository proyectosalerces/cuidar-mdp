        ...
        <aside className={styles.contactSidebar}>
          ...
          <div className={styles.priceCard}>
            ...
            <div className={styles.ctaGroup}>
              ...
              <Button variant="whatsapp" fullWidth href={whatsappLink} onClick={() => track('whatsapp')}>
                Hablar por WhatsApp
              </Button>
            </div>
          </div>
          ...
          <div className={styles.contactInfo}>
            ...
            {showPhone && (
              <div className={styles.contactItem}>
                ...
                <a href={`tel:${residencia.telefono}`} className={styles.contactLink} onClick={() => track('telefono')}>
            ...
            {showEmail && residencia.email && (
              <div className={styles.contactItem}>
                ...
                <a href={`mailto:${residencia.email}`} className={styles.contactLink} onClick={() => track('email')}>
                  {residencia.email}
                </a>
              </div>
            )}
